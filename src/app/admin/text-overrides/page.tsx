        ...
        <CardContent>
          {rows.length === 0 ? (
            <p className="text-sm text-slate-500">
              Wenn ein Default-Text geaendert werden soll, Pencil-Icon auf der
              jeweiligen Seite klicken (EditableText kommt mit SLC-137). Diese
              Liste zeigt nur tatsaechlich gespeicherte Overrides — kein
              Override = Default-Text aktiv.
            </p>
          ) : (
            <Table>
              <TableHeader>
