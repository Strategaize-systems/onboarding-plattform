...
import { Users, FileText, BookOpen, ClipboardCheck, LogOut, Menu, X, Shield, Building2, BarChart3, Pencil, HelpCircle, Eye, Sparkles, UserCog } from "lucide-react";
...
const NAV_ITEMS = [
  ...
  { href: "/admin/berater", label: "Berater", icon: UserCog },
  ...
  { href: "/dashboard", label: "Mandanten-Demo", icon: Eye },
