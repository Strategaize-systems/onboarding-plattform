...
|----|---------|--------|------|---------|
| FEAT-001 | Foundation Data Model & RBAC | deployed | [Spec](FEAT-001-foundation-data-model-rbac.md) | 2026-04-14 |
| FEAT-002 | Exit-Readiness Template | deployed | [Spec](FEAT-002-exit-readiness-template.md) | 2026-04-14 |
| FEAT-003 | Questionnaire Mode with Block-Submit | deployed | [Spec](FEAT-003-questionnaire-block-submit.md) | 2026-04-14 |
...
## V4.1 Features (Handbuch-Reader + Berater-Review-Workflow)
...
| ID | Feature | Status | Spec | Created |
|----|---------|--------|------|---------|
| FEAT-058 | Diagnose-Funnel-Telemetrie (diagnose_event + Tracker + Analytics-Page) | deployed | [Spec](FEAT-058-diagnose-funnel-telemetrie.md) | 2026-05-20 |
| FEAT-060 | Bericht-Email mit PDF-Attachment (@react-pdf/renderer) | deployed | [Spec](FEAT-060-bericht-email-pdf.md) | 2026-05-20 |
...
| ID | Feature | Status | Spec | Created |
|----|---------|--------|------|---------|
| FEAT-063 | 10-Prinzipien-Teaser-Template + Stufen-Lookup-Daten (53 Fragen inkl. 6 KI-Erweiterungen, 90+ Stufen-Inhalts-Bloecke) | deployed | [Spec](FEAT-063-mandanten-report-teaser-template.md) | 2026-05-28 |
...
V9-Scope (Requirements DONE 2026-06-01 via RPT-374 + Architecture DONE 2026-06-01 via RPT-375 + Slice-Planning DONE 2026-06-01 via RPT-376). Bulk-Import von GF-Email-Korrespondenz zur Handbuch-Vervollstaendigung. Persona V9.0 = GF im eigenen Tenant. Daten-Quelle = `.mbox`-Upload (Modus C Hybrid). 5 Features bauen die Pipeline Upload → KI-Pre-Filter → Filter-Review → Thread-Aggregation → PII-Redaction → Pattern-Extraktion → Curation → Handbuch-Snapshot. Foundation-Reuse hoch: FEAT-013 Evidence-Mode (V2 deployed) als Storage/Bucket/Chunk-Pattern, V5 PII-Redaction (deployed) als Pipeline-Stufen-Reuse, FEAT-025 Capture-Mode-Hook (V4 deployed) fuer Mode `email_bulk`, FEAT-026/028 V4/V4.1 Handbuch als Konsum-Endpunkt. **Slice-Konsolidierung 5 -> 4** (SLC-165..168), ~20-27 MTs, ~13-17 Tage Code-Side. Status `in_progress` ab Code-Start.

| ID | Feature | Status | Spec | Created |
|----|---------|--------|------|---------|
| FEAT-070 | Bulk-Email-Upload + .mbox/.eml-Parser | deployed | [Spec](FEAT-070-bulk-email-upload-mbox-parser.md) | 2026-06-01 |
| FEAT-071 | KI-Pre-Filter-Klassifikation (Haiku) + Filter-Review-UI | deployed | [Spec](FEAT-071-ki-pre-filter-klassifikation-haiku.md) | 2026-06-01 |
...
| ID | Feature | Status | Spec | Created |
|----|---------|--------|------|---------|
| FEAT-090 | StB-Onboarding-Rahmen (Stufe-1 Eigen-Kanzlei-Account, Reuse OP-Tenant-Onboarding, kein Billing) | deployed | [Spec](FEAT-090-stb-onboarding-rahmen.md) | 2026-06-20 |
| FEAT-091 | Modul-Domaene + Content-Seed (B1-Cut: M-04 zuerst, dann 18-Cut content-gated; M-05 raus, DEC-242) + KI-Hebel-Katalog (Reifegrad 1-4, lebende Dokumente) | done | [Spec](FEAT-091-modul-domaene-seed.md) | 2026-06-20 |
| FEAT-092 | Blueprint-Diagnostik (eigene Kanzlei, Strukturen sichtbar, Routing in die Module) | in_progress | [Spec](FEAT-092-blueprint-diagnostik.md) | 2026-06-20 |
...
| ID | Feature | Status | Spec | Created |
|----|---------|--------|------|---------|
| FEAT-110 | DB/Authz-Hardening: tier-INSERT-Guard-Migration (ISSUE-125) + evidence/list Cross-Tenant-Ownership-Check (ISSUE-124) + berater-RPC uid-Guard (ISSUE-129) + SECURITY-DEFINER search_path-Sweep (SEC-001) + profiles.role-Trigger-Port | deployed | PRD §V20 | 2026-07-09 |
| FEAT-111 | XSS/Output/Headers-Hardening: Handbook rehype-sanitize (ISSUE-121) + SVG-MIME-Block/Logo-Route-Haertung (ISSUE-122) + globale CSP/COOP Report-Only→enforcing (ISSUE-127) + branding-Render-Re-Validierung (ISSUE-130) + Legal-Page-XSS-Check | deployed | PRD §V20 | 2026-07-09 |
| FEAT-112 | Auth/Secrets-Cleanup: account-scoped Login-Lockout (ISSUE-126) + recording-ready Path-Traversal-Haertung (ISSUE-123) + verifyCronSecret timingSafeEqual-Sweep (ISSUE-131) + Logger-Redaction P-092 (ISSUE-132) + partner-slug .eq/Charset (ISSUE-128) | deployed | PRD §V20 | 2026-07-09 |
