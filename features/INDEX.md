...
| ID | Feature | Status | Spec | Created |
|----|---------|--------|------|---------|
| FEAT-080 | Cross-Thread-Synthese-Stage (dedup/merge/frequency-weight email_pattern → konsolidierte Kandidaten-Units) | done | [Spec](FEAT-080-cross-thread-synthese-stage.md) | 2026-06-12 |
| FEAT-081 | Bounded Critic/Quality-Gate (Analyst↔Challenger-Prinzip, 1 Pass, Hard-Cost-Cap erhalten) | done | [Spec](FEAT-081-bounded-critic-gate.md) | 2026-06-12 |
