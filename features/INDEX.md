...
| FEAT-111 | XSS/Output/Headers-Hardening: Handbook rehype-sanitize (ISSUE-121) + SVG-MIME-Block/Logo-Route-Haertung (ISSUE-122) + globale CSP/COOP Report-Only→enforcing (ISSUE-127) + branding-Render-Re-Validierung (ISSUE-130) + Legal-Page-XSS-Check | in_progress | PRD §V20 | 2026-07-09 |
| FEAT-112 | Auth/Secrets-Cleanup: account-scoped Login-Lockout (ISSUE-126) + recording-ready Path-Traversal-Haertung (ISSUE-123) + verifyCronSecret timingSafeEqual-Sweep (ISSUE-131) + Logger-Redaction P-092 (ISSUE-132) + partner-slug .eq/Charset (ISSUE-128) | in_progress | PRD §V20 | 2026-07-09 |
