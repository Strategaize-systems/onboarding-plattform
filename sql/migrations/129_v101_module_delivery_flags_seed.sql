-- ============================================================================
-- MIG-129 — StB Scoring-Flag-Seed (17 Fachmodule inkl. M-04)
-- SLC-177 (FEAT-096 Phase 1, V10.1, DEC-253/B/E) — /module-delivery Autoring
--
-- Setzt die 5 Scoring-Flags an den 17 stb_modul_*-template-Rows:
--   stb_modul_m01, stb_modul_m02, stb_modul_m03, stb_modul_m04, stb_modul_m06, stb_modul_m07, stb_modul_m08, stb_modul_m15, stb_modul_m16, stb_modul_m26, stb_modul_m27, stb_modul_m28, stb_modul_m35, stb_modul_m36, stb_modul_m38, stb_modul_m39, stb_modul_m42
-- Reiner Daten-Seed (KEIN DDL): UPDATE nur der flachen Flag-Felder in
--   blocks[].questions[]. Content (Fragetext/Themen/KI-Hebel/Counts) unveraendert
--   (Voll-Rebuild aus Live-Snapshot module-blocks-snapshot.json).
--
-- Flag-Quelle: docs/stb-vertikale/module-delivery-flags.json (Sonnet-4-Klassifikation
--   Bedrock Frankfurt eu-central-1, Founder-approved 'alles ok' 2026-07-03).
-- Shape 1:1 zu MIG-125/128 (TemplateQuestion flache Flags). Generator:
--   docs/stb-vertikale/gen-mig129-flag-seed.py (Re-Run => byte-identisch).
--
-- IDEMPOTENZ: reines UPDATE ... WHERE slug/version. Zweiter Apply = identische
--   Flags (deterministisch). Kein INSERT, keine neue Row.
--
-- APPLY (sql-migration-hetzner.md): base64 -> /tmp, dann
--   docker exec -i <supabase-db> psql -U postgres -d postgres < /tmp/129_...sql
-- VERIFY (nur-Flags gesetzt, Content unveraendert):
--   SELECT t.slug, count(*) FILTER (WHERE (q->>'owner_dependency')::bool OR
--     (q->>'deal_blocker')::bool OR (q->>'sop_trigger')::bool OR
--     (q->>'ko_hart')::bool OR (q->>'ko_soft')::bool) AS flagged,
--     count(*) AS questions
--   FROM public.template t, jsonb_array_elements(t.blocks) b,
--     jsonb_array_elements(b->'questions') q
--   WHERE t.slug LIKE 'stb_modul_%' GROUP BY t.slug ORDER BY t.slug;
-- ============================================================================

BEGIN;

-- ── stb_modul_m01 · 17 Fragen · 12 geflaggt ──
UPDATE public.template SET
  ...
  updated_at = now()
WHERE slug = 'stb_modul_m01' AND version = '1.0';

-- ── stb_modul_m02 · 17 Fragen · 14 geflaggt ──
UPDATE public.template SET
  blocks     = $blocks$[
  {
  ...
  updated_at = now()
WHERE slug = 'stb_modul_m02' AND version = '1.0';

-- ── stb_modul_m03 · 17 Fragen · 15 geflaggt ──
UPDATE public.template SET
  blocks     = $blocks$[
  {
  ...
  updated_at = now()
WHERE slug = 'stb_modul_m03' AND version = '1.0';

-- ── stb_modul_m04 · 26 Fragen · 21 geflaggt ──
UPDATE public.template SET
  blocks     = $blocks$[
  {
  ...
  updated_at = now()
WHERE slug = 'stb_modul_m04' AND version = '1.0';

-- ── stb_modul_m06 · 24 Fragen · 15 geflaggt ──
UPDATE public.template SET
  blocks     = $blocks$[
  {
  ...
  updated_at = now()
WHERE slug = 'stb_modul_m06' AND version = '1.0';

-- ── stb_modul_m07 · 22 Fragen · 17 geflaggt ──
UPDATE public.template SET
  blocks     = $blocks$[
  {
  ...
  updated_at = now()
WHERE slug = 'stb_modul_m07' AND version = '1.0';

-- ── stb_modul_m08 · 17 Fragen · 17 geflaggt ──
UPDATE public.template SET
  blocks     = $blocks$[
  {
  ...
  updated_at = now()
WHERE slug = 'stb_modul_m08' AND version = '1.0';

-- ── stb_modul_m15 · 17 Fragen · 9 geflaggt ──
UPDATE public.template SET
  blocks     = $blocks$[
  {
  ...
  updated_at = now()
WHERE slug = 'stb_modul_m15' AND version = '1.0';

-- ── stb_modul_m16 · 17 Fragen · 9 geflaggt ──
UPDATE public.template SET
  blocks     = $blocks$[
  {
  ...
  updated_at = now()
WHERE slug = 'stb_modul_m16' AND version = '1.0';

-- ── stb_modul_m26 · 24 Fragen · 16 geflaggt ──
UPDATE public.template SET
  blocks     = $blocks$[
  {
  ...
  updated_at = now()
WHERE slug = 'stb_modul_m26' AND version = '1.0';

-- ── stb_modul_m27 · 24 Fragen · 14 geflaggt ──
UPDATE public.template SET
  blocks     = $blocks$[
  {
  ...
  updated_at = now()
WHERE slug = 'stb_modul_m27' AND version = '1.0';

-- ── stb_modul_m28 · 24 Fragen · 17 geflaggt ──
UPDATE public.template SET
  blocks     = $blocks$[
  {
  ...
  updated_at = now()
WHERE slug = 'stb_modul_m28' AND version = '1.0';

-- ── stb_modul_m35 · 24 Fragen · 16 geflaggt ──
UPDATE public.template SET
  blocks     = $blocks$[
  {
  ...
  updated_at = now()
WHERE slug = 'stb_modul_m35' AND version = '1.0';

-- ── stb_modul_m36 · 17 Fragen · 6 geflaggt ──
UPDATE public.template SET
  blocks     = $blocks$[
  {
  ...
  updated_at = now()
WHERE slug = 'stb_modul_m36' AND version = '1.0';

-- ── stb_modul_m38 · 17 Fragen · 15 geflaggt ──
UPDATE public.template SET
  blocks     = $blocks$[
  {
  ...
  updated_at = now()
WHERE slug = 'stb_modul_m38' AND version = '1.0';

-- ── stb_modul_m39 · 17 Fragen · 9 geflaggt ──
UPDATE public.template SET
  blocks     = $blocks$[
  {
  ...
  updated_at = now()
WHERE slug = 'stb_modul_m39' AND version = '1.0';

-- ── stb_modul_m42 · 16 Fragen · 11 geflaggt ──
UPDATE public.template SET
  blocks     = $blocks$[
  {
  ...
  updated_at = now()
WHERE slug = 'stb_modul_m42' AND version = '1.0';
