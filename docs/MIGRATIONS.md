...
### MIG-058 — V9.1 SLC-V9.1-A MT-2 ALTER email_bulk_run + email_message: inbound_source + retention + raw_storage_path (Migration 113, geplant)
- Date: 2026-06-09 (DRAFT — Apply in SLC-V9.1-A MT-2 nach MIG-057-LIVE)
- Scope:
...
### MIG-057 — V9.1 SLC-V9.1-A MT-1 Inbound-Foundation: 3 neue Tabellen + RLS + CHECK-Erweiterungen (Migration 112, geplant)
- Date: 2026-06-09 (DRAFT — Apply in SLC-V9.1-A MT-1 als erster V9.1-Migration)
- Scope:
