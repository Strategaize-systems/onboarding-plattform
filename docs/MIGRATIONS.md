...
### MIG-028 — V4.1 SLC-041 `block_review`-Tabelle + RLS + Backfill + Insert-Trigger (Migration 079, geplant)
- Date: 2026-04-28 (geplant fuer SLC-041 Implementation)
...
- Live-Deploy: TBD nach SLC-041-Implementation. Pattern: base64-pipe + `psql -U postgres` auf Onboarding-Server analog MIG-027.
