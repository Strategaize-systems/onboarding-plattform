...
### MIG-041 — V7 SLC-131 partner_organization.slug + Backfill + UNIQUE (Migration 097, geplant)
- Date: 2026-05-18 (geplant; Live-Apply in /backend SLC-131)
- Scope:
...
### MIG-042 — V7 SLC-132 pending_signup + partner_client_mapping invitation_source + DSGVO-Consent (Migration 098, geplant)
- Date: 2026-05-18 (geplant; Live-Apply in /backend SLC-132)
- Scope:
