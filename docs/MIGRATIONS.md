...
### MIG-124 — V10 StB-Vertikale Modul-Liefer-Domaene (`modul_output` + module_output_synthesis-Job + RPC) (PLANNED — /architecture-Skizze, noch nicht geschrieben/applied)
- Date: 2026-06-21
