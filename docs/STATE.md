...
- Current Focus: **V4.2 /go-live CONDITIONAL GO 2026-05-01 (RPT-129).** Gestaffeltes Release: Frontend (Wizard + HelpSheet + InactiveCard + Filter + Settings + 5 Tooltips) bereits LIVE seit 918377a + verifiziert (RPT-127). Cron-Reminder-Pipeline gated bis 4 User-Pre-Deploy-Aktionen: (1) CRON_SECRET in Coolify-ENV [Wert generiert: `322b0a07031acb909909c937bb30492da0687365e678af991191c98803801b7a`], (2) Coolify-Redeploy fuer fixed docker-compose.yml (commit 6f1fb67 mit CRON_SECRET-Durchreichung), (3) DKIM in IONOS aktivieren — DNS-Check zeigt s1/s2 LEER (ISSUE-032), (4) Coolify-Scheduled-Task fuer /api/cron/capture-reminders anlegen. RELEASES.md REL-010 als DRAFT angelegt, Finalisierung in /deploy.
