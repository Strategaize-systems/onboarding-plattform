...
- Current Focus: **V5 Slice-Planning done 2026-05-05.** 4 Slice-Files unter `/slices/SLC-071..074-*.md` angelegt mit insgesamt 25 Micro-Tasks (SLC-071: 9 MTs / SLC-072: 5 MTs / SLC-073: 6 MTs / SLC-074: 5 MTs). slices/INDEX.md hat neue V5-Sektion + Execution-Order. planning/backlog.json BL-077..080 → `in_progress`. Execution-Order: **SLC-071 → SLC-072 → SLC-073 → BL-076-Hotfix → SLC-074** — BL-076 (Cron-Idempotenz-Hotfix) bewusst zwischen SLC-073 und SLC-074 platziert, weil SLC-074 den neuen `walkthrough-cleanup-daily`-Cron baut und das gefixte Idempotenz-Pattern dort sofort wiederverwendet. Alle V5-Slices nutzen Worktree-Isolation (SaaS-Mandat). Pflicht-Gates: SLC-071 Pre-Apply-Backup + Migration-Live-Deploy 082→083→084 strikt sequentiell + Browser-Capability-Check; SLC-072 Live-Smoke End-to-End + Backwards-Compat alter Job-Types; SLC-073 Browser-Smoke alle 3 Routen + Approve mit/ohne Checkbox; BL-076 done VOR SLC-074-Beginn; SLC-074 SC-V5-4 16-Faelle-RLS-Matrix + SC-V5-1 Mitarbeiter-Self-Test + SC-V5-3 Berater-Review-Smoke + SC-V5-5 Code-Quality (0/0 Lint, 0 Vulns). Gesamt-V5-/qa nach SLC-074. V4.4 Re-Check 2026-05-06 ~14:18 laeuft parallel ohne Konflikt.
- Current Phase: V5 Slice-Planning (Walkthrough-Mode MVP). Naechste Phase: /backend SLC-071 (Migration + Capture-UI + Direct-Upload, 9 MTs).

## Immediate Next Steps
1. **/backend SLC-071** — V5 Foundation-Slice mit 9 MTs. Erste Aktion: Pre-Apply-Backup + MIG-031 Migration 082 (CHECK-Erweiterung capture_mode + knowledge_unit.source) auf Live-DB via base64-pipe + `psql -U postgres`. Eigene Session empfohlen (Migration-Apply braucht volle Aufmerksamkeit).
