...
- Current Focus: **V4.3 SLC-051 /frontend + /qa Code-side PASS 2026-05-02 (RPT-136 + RPT-137).** Reader-UX-Bundle vollstaendig code-side abgeschlossen: useScrollSpy + Scroll-Spy-Sidebar + CopyPermalinkButton (sonner) + h2/h3-Integration + ReaderSkeleton + loading.tsx + Mobile-h1-Override + h1-Anchor-Hit-Area-Fix. /qa: 0 Blocker/High/Medium, 3× Low (INDEX-ohne-Sidebar-Eintrag akzeptiert, Mobile-Tap-Target Live-Verify, Tooltip-Layout-Verhalten Live-Verify). 8/8 SLC-051-Tests gruen, 344/344 ENV-unabh. gesamt. Stub-Detection PASS (keine echten Stubs). Wiring-Verification PASS (4 Chains). 9 ACs Code-side bestaetigt; 5 ACs Live-Verify-Pflicht. Live-Smoke (1280×800 + 375×667 Pflicht-Gate SC-V4.3-2) gebuendelt mit Gesamt-V4.3-Deploy nach SLC-054 (Pattern aus RPT-135 SLC-053 bestaetigt). V4.3 2/6 Slices code-side done. Naechster Schritt: /backend SLC-052.
- Current Phase: V4.3 SLC-051 /qa Code-side PASS. Naechste Phase: /backend SLC-052 (Worker+Templates-Hygiene).

## Immediate Next Steps
1. **/backend SLC-052** (Worker+Templates-Hygiene) per V4.3-DEC-062-Reihenfolge. Slugify-Util-Module geteilt mit Reader, Umlaut-Konsistenz im Worker-TOC-Output, User-Pflicht: Demo-Snapshot manuell re-generaten zur Verifikation.
