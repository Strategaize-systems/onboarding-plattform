...
- Next Action: `if (!run.storage_path.startsWith(`${run.tenant_id}/`)) throw new Error("storage_path tenant prefix mismatch");` in handle-parse-job.ts zwischen Load (L116) und Status-Skip-Check (L127) einbauen. ~2 Zeilen. **Bewertet in RPT-388 MT-6-/qa 2026-06-02**: bewusst nicht in MT-6-/qa eingebaut (MT-5-Code, Vermischung der QA-Trails). Mini-Fix-Bundle (ISSUE-088 + ISSUE-089 zusammen, ~10min, 5 Zeilen Code + 2 Vitest-Cases) als separater Pass vor Gesamt-/qa SLC-165 ODER als Sub-Step in Gesamt-/qa.
- Quelle: RPT-386 Finding F-2; Bewertung RPT-388.
...
- Next Action: Analog zum Happy-Path Error-Check + Re-Throw ergaenzen. 2-3 Zeilen. **Bewertet in RPT-388 MT-6-/qa 2026-06-02**: bewusst nicht in MT-6-/qa eingebaut (MT-5-Code, Vermischung der QA-Trails). Mini-Fix-Bundle (ISSUE-088 + ISSUE-089 zusammen, ~10min, 5 Zeilen Code + 2 Vitest-Cases) als separater Pass vor Gesamt-/qa SLC-165 ODER als Sub-Step in Gesamt-/qa.
- Quelle: RPT-386 Finding F-1; Bewertung RPT-388.
